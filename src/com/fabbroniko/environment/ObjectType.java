...
public enum ObjectType {
	...
	* Player's type.
	*/
	TYPE_PLAYER ("/com/fabbroniko/Mario/MarioSprites.png", new Dimension(28,26)),
	
	/**
	* Enemy's type.
	*/
	TYPE_ENEMY ("/com/fabbroniko/Enemy/GhostSprites.png", new Dimension(27,48)),

	/**
	* Block's type.
	*/
	TYPE_BLOCK ("/com/fabbroniko/Blocks/BlockSprites.png", new Dimension(30,30)),

	/**
	* Invisible Block's type.
	*/
	TYPE_INVISIBLE_BLOCK ("/com/fabbroniko/Blocks/InvisibleBlockSprites.png", new Dimension(30, 30)),

	/**
	* Falling Block's type.
	*/
	TYPE_FALLING_BLOCK ("/com/fabbroniko/Blocks/FallingBlockSprites.png", new Dimension(90, 30)),

	/**
	* Castle's type.
	*/
	TYPE_CASTLE ("/com/fabbroniko/Blocks/Castle.png", new Dimension(170, 175)),
